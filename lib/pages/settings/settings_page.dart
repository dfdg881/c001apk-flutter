          ...
          DropDownMenuItem(
            ...
            items: FollowType.values
                .map((type) => DropdownMenuItem<int>(
                      ...
                      child: Text(type == FollowType.ALL ? '全部' : type == FollowType.USER ? '用户' : type == FollowType.TOPIC ? '话题' : type == FollowType.PRODUCT ? '产品' : '应用'),
                    ))
                .toList(),
          ),
          /*
          DropDownMenuItem(
            ...
            items: ImageQuality.values
                .map((type) => DropdownMenuItem<int>(
                      ...
                      child: Text(type == ImageQuality.AUTO ? '自动' : type == ImageQuality.ORIGIN ? '原图' : '缩略图'),
                    ))
                .toList(),
          ),
          const SwitchItem(
